...
export var useAugmentedForm = function (props) {
    ...
    var defaultValuesIncludingRecord = useMemo(function () { return getFormInitialValues(defaultValues, record); }, [JSON.stringify({ defaultValues: typeof defaultValues === 'function' ? 'function' : defaultValues, record: record })] // eslint-disable-line
    );
