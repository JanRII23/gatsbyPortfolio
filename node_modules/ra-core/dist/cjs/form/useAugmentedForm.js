...
var useAugmentedForm = function (props) {
    ...
    var defaultValuesIncludingRecord = (0, react_1.useMemo)(function () { return (0, getFormInitialValues_1.default)(defaultValues, record); }, [JSON.stringify({ defaultValues: typeof defaultValues === 'function' ? 'function' : defaultValues, record: record })] // eslint-disable-line
    );
    ...
    var handleSubmit = (0, react_1.useCallback)(function (values) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    if (errors != null) {
                        (0, setSubmissionErrors_1.setSubmissionErrors)(errors, form.setError);
                    }
                    return [2 /*return*/];
            }
        });
